...
public class ChushouhetongEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChushouhetongEntity() {
		
	}
	
	public ChushouhetongEntity(T t) {
		try {
	 ...
	 * 设置：出售合同
	 */
	public void setChushouhetong(String chushouhetong) {
		this.chushouhetong = chushouhetong;
	}
	/**
	 * 获取：出售合同
	 */
	public String getChushouhetong() {
		return chushouhetong;
	}
