...
public class FangwuchushouEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FangwuchushouEntity() {
		
	}
	
	public FangwuchushouEntity(T t) {
		try {
	...
	private String chushouzhuangtai;
	 ...
	 * 设置：出售状态
	 */
	public void setChushouzhuangtai(String chushouzhuangtai) {
		this.chushouzhuangtai = chushouzhuangtai;
	}
	/**
	 * 获取：出售状态
	 */
	public String getChushouzhuangtai() {
		return chushouzhuangtai;
	}
	/**
	 * 设置：公司账号
	 */
