<template>
  <div :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='dichangongsi'"  label="公司账号" prop="gongsizhanghao">
          <el-input v-model="ruleForm.gongsizhanghao" readonly              placeholder="公司账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='dichangongsi'"  label="公司名称" prop="gongsimingcheng">
          <el-input v-model="ruleForm.gongsimingcheng"               placeholder="公司名称" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}' v-if="flag=='dichangongsi'" label="图片" prop="tupian">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='dichangongsi'"  label="联系人" prop="lianxiren">
          <el-input v-model="ruleForm.lianxiren"               placeholder="联系人" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='dichangongsi'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='dichangongsi'"  label="公司地址" prop="gongsidizhi">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="邮箱" prop="email">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.gongsizhanghao)&& 'dichangongsi'==this.flag){
        this.$message.error('公司账号不能为空');
        return
      }


      if((!this.ruleForm.gongsimingcheng)&& 'dichangongsi'==this.flag){
        this.$message.error('公司名称不能为空');
        return
      }


      if((!this.ruleForm.mima)&& 'dichangongsi'==this.flag){
      ...
      if( 'dichangongsi' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
